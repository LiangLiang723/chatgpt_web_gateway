...
Task 1/2/3/4 已实现：migration 003、logical File / SHA-256 physical Blob、`/v1/files` 五接口、URL/Data URL/Base64/`file_id` Attachment Resolver/security/staging，以及 ordered multimodal canonical Context 与 FRESH/APPEND/RESTORE/REBUILD upload selection。ChatGPT upload readiness、Conversation attachment lifecycle 与 authenticated real E2E 仍未完成。
