...
当前 V1 实现/验收收口不会自动创建新的公开版本、Git Tag、Docker Registry 镜像或 GitHub Release；除非另有明确发布指令。
